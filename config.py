...
def parse_args():
    ...
    parser.add_argument("--n-pc", type=int, default=2048, help="Number of points in the point cloud.")
    ...
    # parser.add_argument("--n_parts", type=int, nargs='+', default=[8,16,36], help="Number of parts")
    ...
    # parser.add_argument("--plane_fdim", type=int, default=8, help="Plane feature dimension")
    # parser.add_argument("--inf_dim", type=int, default=3, help="Input dimension")
    # parser.add_argument("--zf_dim", type=int, default=512, help="Hidden dimension")
    # parser.add_argument("--tf_dim", type=int, default=4, help="Token dimension")
    # parser.add_argument("--ef_dim", type=int, default=256, help="Encoder dimension")
    # parser.add_argument("--gf_dim", type=int, default=256, help="generator dimension")
